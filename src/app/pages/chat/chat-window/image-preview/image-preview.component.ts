...
@Component({
  ...
  template: `
    <div class="z-40 fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
      <div class="bg-white p-8 rounded-lg shadow-lg max-w-[550px] max-h-[550px] sm:max-w-[1200px] sm:max-h-[1200px]">
        <div class="flex justify-between items-center mb-6">
            <img class="flex-1" [src]="data.base64String" class="max-w-[450px] max-w-h-[450px] sm:max-w-[1150px] sm:max-h-[1150] mx-auto" />
        </div>
