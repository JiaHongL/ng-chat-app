  ...
  template: `
    <div class="mx-2">
      <input 
        ...
        accept="image/jpeg,image/png,image/bmp,image/svg+xml,image/webp" 
      />
      <svg (click)="onUpload()" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
